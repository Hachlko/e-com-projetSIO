...
<div class="container my-3">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center">Add un Produit - Admin</h1>
        </div>
    </div>
        ...
        <div class="col-8">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" value="<?= isset($_POST['price']) ? $_POST['price'] : " "; ?>" name='price' class="form-control">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="image" class="form-control" type="file" accept="image/png, image/jpg">
                </div>
