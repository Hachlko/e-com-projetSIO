...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center">Update Produits - Admin</h1>
        </div>
    </div>
        ...
        <div class="col-8">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text" value="<?= isset($product) ? $product->nomProduit : " "; ?>" name='name' class="form-control">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" value="<?= isset($product) ? $product->prixUnit : " "; ?>" name='price' class="form-control">
                </div>
                <div class="mb-3">
                    <label for="stock" class="form-label">Stock actuel : </label>
                    <input type="number" value="<?= isset($product) ? $product->qteStock : " "; ?>" name='stock' class="form-control">
                </div>
                <div class="mb-3">
