...
<head>
    ...
    <title>E-com PoolTime - <?= $pageTitle ?> </title>
        ...
        <div class="row">
            <div class="col-12">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="<?= ROOT ?>home">PoolTime !</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="<?= ROOT ?>products">Les Produits</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <?php if (isset($data['userData'])) : ?>
                                    <li class="nav-item">
                                        <a href="<?= ROOT ?>profil" class="nav-link"><?= $data['userData']->uMail ?></a>
                                    </li>
                                    <li class="nav-item">
